/*
Run this using dbt run --select fct_orders_product_daily
Then see how it looks in the dev warehouse on Postgres
Then run dbt run --select fct_orders_product_daily --target prod to push to production 
*/
